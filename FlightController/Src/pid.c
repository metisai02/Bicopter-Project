...
extern volatile float Kp_angle_roll;
extern volatile float Ki_angle_roll;
extern volatile float Kd_angle_roll;

extern volatile float Kp_rate_pitch;
extern volatile float Ki_rate_pitch;
extern volatile float Kd_rate_pitch;

extern volatile float Kp_rate_roll;
extern volatile float Ki_rate_roll;
extern volatile float Kd_rate_roll;

extern volatile float Kp_rate_yaw;
extern volatile float Ki_rate_yaw;

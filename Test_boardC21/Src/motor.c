...
#endif
#define MOTOR_RIGHT_OFFSET 200 // YELLOW
#define MOTOR_LEFT_OFFSET 150  // WHITE
void calculate_motor_output(uint16_t *esc_right, uint16_t *esc_left, uint16_t *servo_right, uint16_t *servo_left, uint16_t throttle_rc, PID_t *pid)
{
    ...
    // value PWM
    *esc_right = throttle_rc + pid->PID_roll_out - MOTOR_RIGHT_OFFSET;
    *esc_left = throttle_rc - pid->PID_roll_out - MOTOR_LEFT_OFFSET;
